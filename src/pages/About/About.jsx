    ...
    return (
        <div className="container">
            ...
            <div className="about-container">
                ...
                <p>Whether you're a trivia enthusiast or just looking for a fun way to pass the time, Quizzical has something for everyone. Start playing today and see how many questions you can answer correctly!</p>
            </div>
            <Footer />
        </div>
    )
