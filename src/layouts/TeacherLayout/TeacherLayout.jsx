...
const TeacherLayout = ({ theme, toggleTheme }) => {
    ...
    return (
        <div className="admin-layout">
            <Sidebar className="admin-sidebar" title="Teacher Workspace" collapsed={collapsed} handleToggleSidebar={handleToggleSidebar} opened={opened} handleCloseSidebar={() => setOpened(false)} items={sidebarItems} />
